  ...
  <div class="layout-container">
    <div class="layout-container-form flex space-between">
      <el-form :inline="true" :model="queryParams" class="demo-form-inline" ref="queryForm">
        ...
        <el-form-item label="台账内容" prop="traceContent">
          <el-input v-model="queryParams.traceContent" placeholder="请输入" clearable />
        </el-form-item>
        <el-form-item label="来源" prop="traceSource">
          <el-select v-model="queryParams.traceSource">
    ...
    <div class="layout-container-table">
      ...
      >
        ...
        <el-table-column prop="traceContent" label="台账内容" align="center" />
     ...
     <!-- 添加或修改标签对话框 -->
   <el-dialog title="新增记录" v-model="open" width="500px" append-to-body>
     <el-form ref="ruleFormRef" :model="form" :rules="rules" label-width="120px">
       ...
       <el-form-item label="跟进内容" prop="traceContent">
         <el-input v-model="form.traceContent"  type="textarea" :rows="8"  placeholder="请输入" />
       </el-form-item>
     </el-form>
...
import { listRecord,tableList,getPeople,addRecord } from '@/api/progressIndex'
