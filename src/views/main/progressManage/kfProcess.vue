  ...
  <div class="layout-container">
    <div class="layout-container-form flex space-between">
      <el-form :inline="true" :model="queryParams" class="demo-form-inline" ref="queryForm">
        ...
        <el-form-item label="客服内容" prop="callContent">
          <el-input v-model="queryParams.callContent" placeholder="请输入" clearable />
        </el-form-item>
        <el-form-item label="咨询类型" prop="callType">
          <el-select v-model="queryParams.callType">
    ...
    <div class="layout-container-table">
      ...
      >
        ...
        <el-table-column label="咨询类型" prop="traceSource" align="center">
          <template #default="scope">
              {{scope.row.callType ==1?'咨询':'投诉'}}
          </template>
        </el-table-column>
        <el-table-column prop="callContent" label="客服内容" align="center" width="400"/>
   ...
   <el-dialog title="新增记录" v-model="open" width="800px" append-to-body>
     <el-form ref="ruleFormRef" :model="form" :rules="rules" label-width="120px">
       ...
       <el-form-item label="授信人列表(个人)" prop="sourceId" >
       ...
       <el-form-item label="跟进来源" prop="callType">
         <el-select v-model="form.callType" placeholder="请选择">
            <el-option
       ...
       <el-form-item label="跟进内容" prop="traceContent">
         <el-input v-model="form.callContent"  type="textarea" :rows="8"  placeholder="请输入" />
       </el-form-item>
     </el-form>
...
import { callRecord,tableList,getPeople,callAdd } from '@/api/progressIndex'
...
export default defineComponent({
  ...
  setup() {
    ...
    //打开新增记录
    const handleAdd =()=>{
      form.value.callContent = null
      form.value.sourceId = ''
      form.value.callType = null
      const params={
        networkName:''
      }
    ...
    const toCon = (i:any)=>{
      ...
      form.value.callType = i.callType
