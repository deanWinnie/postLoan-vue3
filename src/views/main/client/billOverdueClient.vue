  ...
  <div class="layout-container">
    <div class="layout-container-form flex space-between">
      <el-form :inline="true" :model="queryParams" class="demo-form-inline" ref="queryForm" label-width="80px">
        ...
        <el-form-item label="逾期排序" prop="overdueSort">
          <el-select v-model="queryParams.overdueSort" >
...
export default defineComponent({
  ...
  setup() {
    ...
    const queryParams:any = reactive({
      type:1, //0--所有客户，1--账单逾期，2--银行逾期，3--代偿  4--移交渠道客户
      networkName:'',
      labelId:null,
      districtId:null,
