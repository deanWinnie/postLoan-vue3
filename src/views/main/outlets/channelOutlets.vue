      ...
      >
        ...
        <el-table-column 
          ...
          <template #default="scope">
            ...
            <el-button  link v-else class="col-red" @click="openOverdueBill(scope.row)">{{scope.row.overdueBillAmount}}</el-button>
          </template>
        </el-table-column>
        ...
        <el-table-column label="银行逾期人数" prop="overdueCount" :show-overflow-tooltip="true" align="center" >
          <template #default="scope">
            ...
            <el-button   link v-else class="col-red" @click="openClientList(scope.row,'overdueCount')">{{scope.row.overdueCount}}</el-button>
          </template>
        </el-table-column>
        <el-table-column label="代偿人数" prop="compensatoryCount" :show-overflow-tooltip="true" align="center" >
          <template #default="scope">
            ...
            <el-button link   v-else class="col-red" @click="openClientList(scope.row,'compensatoryCount')">{{scope.row.compensatoryCount}}</el-button>
          </template>
        </el-table-column>
